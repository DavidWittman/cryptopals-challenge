...
const cipherBase64 = "L77na/nrFsKvynd6HzOoG7GHTLXsTVu9qvY/2syLXzhPweyyMTJULu/6/kXX0KSvoOLSFQ=="
const key = "YELLOW SUBMARINE"

func DecryptCTRMessage() []byte {
	ciphertext, err := cryptopals.ReadBase64String(cipherBase64)
	if err != nil {
		panic(err)
	}
